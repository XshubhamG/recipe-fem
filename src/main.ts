...
const recipe = {
	...
	instructions: [
		...
		"<strong>Fold and serve</strong>: When the omelette is almost set, carefully lift one edge and fold it over the fillings. Let it cook for another minute, then slide it onto a plate.",
